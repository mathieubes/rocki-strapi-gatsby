exports.id = "component---src-templates-event-template-tsx";
exports.ids = ["component---src-templates-event-template-tsx"];
exports.modules = {
...
/***/ "./src/templates/event-template.tsx?export=default":
/*!*********************************************************!*\
  !*** ./src/templates/event-template.tsx?export=default ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EventTemplate)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _event_template_sass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./event-template.sass */ "./src/templates/event-template.sass");
/* harmony import */ var _event_template_sass__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_event_template_sass__WEBPACK_IMPORTED_MODULE_3__);
...
function getDate(month, year, data) {
  console.log(month, year);
  const calendar = [];
  const startDate = moment__WEBPACK_IMPORTED_MODULE_2___default()([year, month]).clone().startOf('month').startOf('week');
  const endDate = moment__WEBPACK_IMPORTED_MODULE_2___default()([year, month]).clone().endOf('month');
  const day = startDate.clone().subtract(1, 'day');
  while (day.isBefore(endDate, 'day')) {
    calendar.push(Array(7).fill(0).map(() => day.add(1, 'day').clone().format('DD')));
  }
  return calendar.map((week, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: index,
    className: "event-template__calendar__week"
  }, week.map(day => {
    const entry = data.find(({
      startDateTime
    }) => {
      return moment__WEBPACK_IMPORTED_MODULE_2___default()([year, month, day]).isSame(moment__WEBPACK_IMPORTED_MODULE_2___default()(startDateTime), 'day');
    });
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: day,
      className: "event-template__calendar__week__day"
    }, !isExtraDays(index, parseInt(day)) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, day, entry && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
      width: 64,
      height: 64,
      src: `http://localhost:1337${entry.event.event_type.defaultIconForCalendar.url}`
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
      to: `/event-detail/${entry.event.id}`
    }, "Je veux voir"))));
  })));
}
function EventTemplate({
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "TOTO"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "event-template__calendar"
  }, getDate(month, year, data.allStrapiScheduleEntry.nodes)));
}
const query = "2282204946";
...
/***/ "./src/templates/event-template.sass":
/*!*******************************************!*\
  !*** ./src/templates/event-template.sass ***!
  \*******************************************/
/***/ (() => {
...
;
//# sourceMappingURL=component---src-templates-event-template-tsx.js.map